...
class HomeController extends Controller
{
    ...
    public function showNews(string $slug)
    {
        ...
        return view('frontend.news-details', compact('news', 'recentNews', 'mostCommonTags', 'previousPost', 'nextPost', 'relatedPosts', 'socialCounts', 'ad'));
    }
    ...
    public function commentDestroy(Request $request)
    {
        ...
        return response(['status' => 'error', 'message' => __('frontend.Something Went Worng!')]);
    }
