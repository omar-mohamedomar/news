...
use App\Http\Requests\FooterGridThreeSaveRequest;
use App\Models\FooterGridThree;
use App\Models\FooterTitle;
use App\Models\Language;
use Illuminate\Http\Request;

class FooterGridThreeConroller extends Controller
{
     ...
     */
    public function store(FooterGridThreeSaveRequest $request)
    {
     ...
     */
    public function update(FooterGridThreeSaveRequest $request, string $id)
    {
        $footer = FooterGridThree::findOrFail($id);
        $footer->language = $request->language;
        $footer->name = $request->name;
