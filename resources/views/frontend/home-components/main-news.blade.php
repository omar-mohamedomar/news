                            ...
                            <div class="article__entry">
                                <div class="article__image">
                                    <a href="{{ route('news-details', $sectionTwoNews->slug) }}">
                                        <img src="{{ $sectionTwoNews->image }}" alt="" class="img-fluid">
                                    </a>
                                </div>
                                <div class="article__content">
                                    <ul class="list-inline">
                    ...
                    @if ($ad->home_middle_ad_status == 1)
                        <div class="small_add_banner">
                            <div class="small_add_banner_img">
                                <a href="{{ $ad->home_middle_ad_url }}"><img src="{{ asset($ad->home_middle_ad) }}"
                                        alt="adds"></a>
                            </div>
                        </div>
                    @endif
