                ...
                <div class="col-sm-6 col-md-8">
                    <div class="topbar-left topbar-right d-flex">
                        ...
                        <div class="topbar-text">
                            {{ date('l, F j, Y') }}
                            {{-- {{ date('l, M d, Y') }}  التانيه تاريخ مفصل اكتر --}}
                        </div>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-hover navbar-expand-lg navbar-soft">
            <div class="container">
                ...
                <figure class="mb-0 mx-auto">
                    <a href="{{ url('/') }}">
                        <img src="{{ $settings['site_logo'] }}" alt="" class="img-fluid logo">
                    </a>
                </figure>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="main_nav99">
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <li class="nav-item"><a class="nav-link"
                                href="{{ route('about') }}">{{ __('frontend.About Us') }}</a></li>
                        <li class="nav-item"><a class="nav-link"
                    ...
                    <nav class="list-group list-group-flush">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item"><a class="nav-link  text-dark"
                                    href="{{ route('about') }}">{{ __('frontend.About Us') }}</a>
                            </li>
                            <li class="nav-item"><a class="nav-link  text-dark"
                                    href="{{ route('contact') }}">{{ __('frontend.Contact') }}</a>
                        </ul>
