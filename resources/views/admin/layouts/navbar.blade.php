    ...
    <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="dropdown-item-desc">
                            {{ __('admin.Welcome to Stisla template!') }}
                            <div class="time">{{ __('admin.Yesterday') }}</div>
                        </div>
                    </a>
                </div>
                <div class="dropdown-footer text-center">
                    <a href="#">{{ __('admin.View All') }} <i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </li>
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">{{ __('admin.Logged in 5 min ago') }}</div>
                <a href="{{ route('admin.profile.index') }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> {{ __('admin.Profile') }}
                </a>
                <a href="features-activities.html" class="dropdown-item has-icon">
                    <i class="fas fa-bolt"></i> {{ __('admin.Activities') }}
                </a>
