                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-2">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="api-tab4" data-toggle="tab" href="#api4" role="tab"
                                    aria-controls="api" aria-selected="false">{{ __('admin.Api Settings') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-12 col-sm-12 col-md-10">
                        <div class="tab-content no-padding" id="myTab2Content">
                            ...
                            <div class="tab-pane fade" id="api4" role="tabpanel" aria-labelledby="api-tab4">
                                @include('admin.setting.cards.api-setting')
                            </div>
                        </div>
                    </div>
                </div>
