        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input class="form-control" required placeholder="{{ __('frontend.Name') }}"
                                        type="text" name="name">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" required placeholder="{{ __('frontend.Email') }}"
                                ...
                                <div class="form-group">
                                    <input class="form-control" required placeholder="{{ __('frontend.Password') }}"
                                ...
                                <div class="form-group">
                                    <input class="form-control" required placeholder="{{ __('frontend.Confirm Password') }}"
                    ...
                    <p class="text-center mt-4 mb-0">{{ __('frontend.Already registered?') }}<a
